...
RUN CGO_ENABLED=0 GOOS=${TARGETOS} GOARCH=${TARGETARCH} go build -o blinkyd -ldflags="-X 'github.com/BrenekH/blinky/vars.Version=${LDFLAGS_VERSION}'" cmd/blinkyd/main.go
